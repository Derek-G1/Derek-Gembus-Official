...
const Quote = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    setPageMeta({
      title: 'Request a Quote | Derek Gembus',
      description:
        'Start with a quick Discovery Intake, generate a Scope of Work PDF, or request a fast project quote.',
      canonicalPath: '/quote'
    });
  ...
  const getPlaceholder = () => {
    ...
    if (
      ...
      selectedPackage.includes('Power BI') ||
      selectedPackage.includes('Tableau') ||
      selectedPackage.includes('Dashboard')
    ) {
      ...
      <div className="pt-24 p-4 md:p-8 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-3xl bg-gray-900/50 p-8 md:p-12 rounded-2xl border border-purple-500/30 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 mb-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link
              to="/discovery"
              className="group rounded-2xl border border-blue-500/30 bg-blue-500/5 hover:bg-blue-500/10 p-5 transition-all hover:scale-[1.01]"
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-white">Discovery Intake (Recommended)</div>
                  <div className="text-sm text-gray-300 mt-1">
                    2–3 minutes. Best for fast quotes + recommendations.
                  </div>
                  <div className="text-xs text-gray-500 mt-2 group-hover:text-gray-400">
                    Includes goals, timeline, budget, and next steps.
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link
              to="/scope-of-work"
              className="group rounded-2xl border border-purple-500/30 bg-purple-500/5 hover:bg-purple-500/10 p-5 transition-all hover:scale-[1.01]"
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-white">Scope of Work PDF</div>
                  <div className="text-sm text-gray-300 mt-1">
                    For serious projects. Generates a formal SOW + deliverables.
                  </div>
                  <div className="text-xs text-gray-500 mt-2 group-hover:text-gray-400">
                    Great when you’re ready to lock in pricing and a schedule.
                  </div>
                </div>
              </div>
            </Link>
          ...
          <button
            ...
            className="relative z-10 w-full flex items-center justify-between px-4 py-3 rounded-xl border border-gray-800 bg-gray-900/40 hover:bg-gray-900/55 transition-all text-left"
          >
            <div>
              <div className="font-semibold text-white">Or request a fast quote using the form below</div>
              <div className="text-xs text-gray-500 mt-1">
                Best if you already know what you want and want a simple estimate.
              </div>
            </div>
            {showQuoteForm ? (
          ...
          {status === 'success' ? (
            <div className="bg-green-500/10 border border-green-500/50 rounded-xl p-8 text-center animate-fade-in mt-6 relative z-10">
              ...
              <p className="text-gray-300">
                Thank you for providing those details. I will review your project scope and get back to you
                within 24 hours.
              </p>
              <Link to="/" className="inline-block mt-6 text-green-400 hover:text-green-300 font-semibold">
                Return Home
              </Link>
            </div>
          ) : (
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.from_name ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.user_email ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                          } text-white focus:border-purple-500 outline-none transition-all`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.user_phone ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                          } text-white focus:border-purple-500 outline-none transition-all`}
                      ...
                      <div className={['Other', 'Social Media', 'Referral'].includes(referralSource) ? 'md:col-span-1' : ''}>
                        ...
                        <select
                          ...
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.referral_source ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                          } text-white focus:border-purple-500 outline-none transition-all appearance-none`}
                        >
                      ...
                      {['Other', 'Social Media', 'Referral'].includes(referralSource) && (
                        <div className="animate-fade-in md:col-span-1">
                          ...
                          <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                              errors.referral_other ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                            } text-white focus:border-purple-500 outline-none transition-all`}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.service_package ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                          } text-white focus:border-purple-500 outline-none transition-all appearance-none`}
                        >
                          <option value="" disabled>
                            Select a service...
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.budget ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                          } text-white focus:border-purple-500 outline-none transition-all appearance-none`}
                        >
                          <option value="" disabled>
                            Select a budget...
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.preferred_payment_method ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                          } text-white focus:border-purple-500 outline-none transition-all appearance-none`}
                        >
                          <option value="" disabled>
                        ...
                        {errors.preferred_payment_method && (
                          <p className="text-red-400 text-xs mt-1">{errors.preferred_payment_method}</p>
                        )}
                      </div>
                      ...
                      <div className="md:col-span-1">
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                            errors.timeline ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                          } text-white focus:border-purple-500 outline-none transition-all appearance-none`}
                        >
                          <option value="" disabled>
                            Select a timeline...
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:border-purple-500 outline-none transition-all"
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          If you have a hard deadline (event, opening, campaign), put it here so I can plan the schedule.
                        </p>
                      </div>
                      ...
                      <div className="md:col-span-2">
                        ...
                        <textarea
                          name="sitemap_or_pages"
                          rows="3"
                          className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:border-purple-500 outline-none transition-all placeholder-gray-500"
                          placeholder="Example: Home, About, Services, Gallery, Contact. Or: 2-page site (Home + Contact)."
                        ></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <select
                          name="business_goal"
                          className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white outline-none transition-all appearance-none"
                        >
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-400 mb-2">
                        Reference Websites <span className="text-xs text-gray-500 ml-2">(Optional - Links to sites you like the look of)</span>
                      </label>
                      <input
                        type="text"
                        name="reference_sites"
                        className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:border-purple-500 outline-none transition-all"
                        placeholder="e.g. www.apple.com, www.competitor.com"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="4"
                      className={`w-full px-4 py-3 rounded-lg bg-gray-800 border ${
                        errors.message ? 'border-red-500 bg-red-500/5' : 'border-gray-700'
                      } text-white focus:border-purple-500 outline-none transition-all placeholder-gray-500`}
                  ...
                  <div className="space-y-3 p-4 bg-purple-500/5 rounded-xl border border-purple-500/20">
                    ...
                    <label className="flex items-start cursor-pointer group">
                      <input
                        type="checkbox"
                        name="ack_third_party"
                        onChange={handleInputChange}
                        className="mt-1 mr-3 h-4 w-4 accent-purple-500"
                      />
                      <span className="text-sm text-gray-300">
                        I understand that hosting, domains, or API fees are the client's responsibility. *
                      </span>
                    </label>
                    ...
                    <label className="flex items-start cursor-pointer group">
                      <input
                        type="checkbox"
                        name="ack_content_freeze"
                        onChange={handleInputChange}
                        className="mt-1 mr-3 h-4 w-4 accent-purple-500"
                      />
                      <span className="text-sm text-gray-300">
                        I understand that delays in content or approvals can pause the project and shift the timeline. *
                      </span>
                    </label>
                    ...
                    <label className="flex items-start cursor-pointer group">
                      ...
                      />
                      <span className="text-sm text-gray-300">
                        I understand that rush timelines may require an additional rush fee. *
                      </span>
                    </label>
                  ...
                  >
                    {status === 'sending' ? (
                      ...
                      <>
                        Send Quote Request <Send className="ml-2 w-5 h-5" />
                      </>
                    )}
                  </button>
