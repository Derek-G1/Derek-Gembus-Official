...
const App = () => {
  ...
  useEffect(() => {
    setPageMeta({
      // SEO TARGET: Optimizing browser title for search engines
      title: 'Derek Gembus | Software Engineer, Data Engineer, Web Developer & Website Designer',
      description: 'Expert Web Developer and Website Designer offering custom software solutions, data engineering, and SEO-friendly web design services.',
      canonicalPath: '/'
    });
  }, []);
  ...
  const services = [
    {
      ...
      price: "Starts at $500",
      description: "Custom-coded, high-performance websites. From single-page portfolios to multi-page business sites with SEO and CMS integration.",
      icon: Layout,
      features: [
        "Single Page: $500",
        "2-Page: $1,000",
    ...
    },
    {
      ...
      description: "Custom mobile applications built with your preferred tech stack. I deliver fully native or cross-platform solutions for maximum reach.",
      icon: Smartphone, 
      features: [
    ...
    },
    {
      ...
      price: "Custom Quote",
      description: "Leverage data and automation to grow your business. Services include data visualization, IT workflow automation, and SEO strategies.",
      icon: BarChart,
      features: [
    ...
    },
    {
      ...
      price: "$25 - $150 / month",
      description: "Secure hosting solutions and continuous maintenance to keep your site running smoothly and safely.",
      icon: Server,
      features: [
        "Standard Plan: $25/mo",
        "Premium Plan: $50/mo",
    ...
    },
    {
      ...
      price: "$50 / hour",
      description: "Flexible technical support for content updates, design tweaks, bug fixes, or consultation outside of maintenance plans.",
      icon: Clock,
      features: [
        "Content Updates",
        "Design Tweaks",
  ...
  const experience = [
    {
      ...
      description: "Delivering custom digital solutions spanning full-stack web development and specialized game modification.",
      details: [
    ...
    },
    {
      ...
      description: "Transformed raw client data into actionable marketing insights for non-profits and commercial enterprises.",
      details: [
  ...
  const education = [
    {
      ...
      details: "Intensive 'Cleveland Codes' Bootcamp covering Full Stack Development (HTML/CSS/JS, Python, SQL) and CRM creation.",
      courses: [
    ...
    }, 
    {
      ...
      details: "IT fundamentals including networking, OS power usage, system administration, and digital security.",
      courses: [
    ...
    },
     {
      ...
      details: "Automating tasks by writing Python scripts, using Git/GitHub for version control, and managing IT resources at scale.",
      courses: [
    ...
    },
    {
      ...
      details: "Gain key analytical skills (data cleaning, analysis, & visualization) using SQL, R programming, and Tableau.",
      courses: [
  ...
  const projects = [
    {
      title: "Block Guard",
      description: "Powerful Android call & message management app with intelligent filtering and DND modes.",
    ...
    },
    {
      ...
      description: "Analytics tool for database developer salaries in the aviation industry, aggregating data from multiple sources.",
    ...
    },
    {
      ...
      description: "High-performance server environment with custom C# mods, MySQL integration, and a VIP e-commerce system.",
    ...
    },
    {
      ...
      description: "High-quality music bot using discord.js v14 and @distube/ytdl-core for stable audio streaming.",
      tags: ["Node.js", "Discord.js", "Backend"],
      icon: Music,
      url: "github.com/Derek-G1/Discord-Music-Bot"
    },
    {
      title: "OBS Map Cover Script",
      description: "Lua script for OBS Studio to prevent stream sniping in Rust by instantly hiding the map key.",
      tags: ["Lua", "OBS Studio", "Automation"],
      icon: FileCode2,
      url: "github.com/Derek-G1/Hide-Map-in-Rust-Game-"
    },
    {
      title: "Sweet Chin Music Ohio",
      description: "Website for a popular cover band with event calendar and booking capabilities.",
      tags: ["Web Dev", "Events"],
      icon: Music,
    ...
    },
    {
      ...
      description: "Restaurant website with online ordering integration for Chicago-style Italian beef.",
    ...
    },
    {
      ...
      description: "Custom WordPress theme and booking platform for a professional entertainer.",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main id="main-content" className="relative">
        ...
        <section id="about" className="py-20 relative overflow-hidden" aria-labelledby="about-heading">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 id="about-heading" className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
                About Me
              </h2>
        ...
        <section id="services" className="py-20 relative bg-black" aria-labelledby="services-heading">
          <div className="container mx-auto px-4">
            <h2 id="services-heading" className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Services
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
              {services.map((service, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-2xl border border-purple-500/30 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex flex-col">
                  ...
                  <Link to="/services" className="mt-auto block w-full py-2 text-center rounded-lg border border-purple-500 text-purple-400 hover:bg-purple-500 hover:text-white transition-all text-sm">
                    Details
                  </Link>
                </div>
              ))}
        ...
        <section id="skills" className="py-20 relative bg-black" aria-labelledby="skills-heading">
          <div className="container mx-auto px-4">
            <h2 id="skills-heading" className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Technical Skills
            </h2>
        ...
        <section id="experience" className="py-20 relative" aria-labelledby="experience-heading">
          <div className="container mx-auto px-4">
            <h2 id="experience-heading" className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Professional Experience
            </h2>
            <div className="max-w-4xl mx-auto space-y-8">
              {experience.map((job, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-2xl border border-purple-500/30 shadow-xl">
                  <div className="relative pl-8 border-l-2 border-purple-500">
                    ...
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                      ...
                      <p className="text-gray-400 mt-2 md:mt-0 bg-gray-800 px-3 py-1 rounded-full text-sm">{job.period}</p>
                    </div>
        ...
        <section id="education" className="py-20 relative bg-black" aria-labelledby="education-heading">
          <div className="container mx-auto px-4">
            <h2 id="education-heading" className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Education & Certifications
            </h2>
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              {education.map((edu, index) => (
                <div key={index} className="bg-gray-900 p-6 rounded-xl border border-gray-800 hover:border-purple-500/50 transition-all flex flex-col h-full">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-800">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {edu.courses.map((course, i) => (
                          <span key={i} className="text-xs px-2 py-1 bg-gray-800 text-gray-400 rounded-md border border-gray-700 hover:border-purple-500/50 hover:text-purple-300 transition-colors">
                            {course}
                          </span>
                        ))}
                      </div>
        ...
        <section id="projects" className="py-20 relative" aria-labelledby="projects-heading">
          <div className="container mx-auto px-4">
            <h2 id="projects-heading" className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Recent Projects
            </h2>
        ...
        <section id="testimonials" className="py-20 relative bg-black" aria-labelledby="testimonials-heading">
          <div className="container mx-auto px-4">
            <h2 id="testimonials-heading" className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              Testimonials
            </h2>
            <div className="max-w-4xl mx-auto grid grid-cols-1 gap-8">
              {testimonials.map((t, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-2xl border border-purple-500/30 shadow-xl relative">
                  <div className="absolute top-8 right-8 text-purple-500/20" aria-hidden="true">
                    <MessageSquareQuote className="w-16 h-16" />
                  </div>
                  <div className="relative z-10">
                    <blockquote className="text-gray-300 text-lg leading-relaxed italic mb-6">"{t.content}"</blockquote>
